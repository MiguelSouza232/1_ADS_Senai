...
('Lucas Rocha', 'SP12345', '11999887711', 'lucas@email.com', '2020-01-15', 'Venda', 5.00),
('Mariana Prado', 'SP23456', '11999887722', 'mariana@email.com', '2019-04-10', 'Locação', 4.50),
('Rafael Nunes', 'SP34567', '11999887733', 'rafael@email.com', '2021-03-20', 'Comercial', 6.00),
('Sofia Carvalho', 'SP45678', '11999887744', 'sofia@email.com', '2018-07-01', 'Alto padrão', 5.50),
('Thiago Melo', 'SP56789', '11999887755', 'thiago@email.com', '2020-11-11', 'Venda', 5.25),
('Vanessa Moura', 'SP67890', '11999887766', 'vanessa@email.com', '2022-02-02', 'Locação', 4.75),
('Bruno Ferreira', 'SP78901', '11999887777', 'bruno@email.com', '2017-09-09', 'Rural', 6.50),
('Paula Reis', 'SP89012', '11999887788', 'paula@email.com', '2023-01-01', 'Lançamentos', 5.00),
('Diego Martins', 'SP90123', '11999887799', 'diego@email.com', '2021-05-05', 'Industrial', 6.25),
('Amanda Torres', 'SP01234', '11999887700', 'amanda@email.com', '2020-10-10', 'Venda', 5.10),
('Gustavo Lima', 'SP10203', '11999887721', 'gustavo@email.com', '2019-12-12', 'Locação', 4.85);
...
('Rua Alpha, 100', 'São Paulo', 'SP', '01001-000', 850000.00, 120.0, 3, 2, 2, 1, 1, 2015),
('Av. Beta, 200', 'Santos', 'SP', '11010-000', 650000.00, 95.0, 2, 2, 1, 2, 2, 2012),
('Rua Gama, 300', 'Campinas', 'SP', '13010-000', 1200000.00, 150.0, 4, 3, 3, 6, 3, 2018),
('Av. Delta, 400', 'São Paulo', 'SP', '01002-000', 450000.00, 75.0, 2, 1, 1, 1, 4, 2010),
('Rua Épsilon, 500', 'Ribeirão Preto', 'SP', '14010-000', 980000.00, 110.0, 3, 2, 2, 1, 5, 2016),
('Av. Zeta, 600', 'São Paulo', 'SP', '01003-000', 1800000.00, 200.0, 5, 4, 4, 2, 6, 2020),
('Rua Eta, 700', 'Santos', 'SP', '11011-000', 550000.00, 90.0, 2, 1, 1, 1, 7, 2011),
('Av. Teta, 800', 'Campinas', 'SP', '13011-000', 750000.00, 100.0, 3, 2, 2, 1, 8, 2014),
('Rua Iota, 900', 'São Paulo', 'SP', '01004-000', 650000.00, 85.0, 2, 2, 1, 1, 9, 2013),
('Av. Kappa, 1000', 'São Paulo', 'SP', '01005-000', 1400000.00, 160.0, 4, 3, 2, 10, 10, 2017),
('Rua Lambda, 1100', 'Santos', 'SP', '11012-000', 430000.00, 70.0, 1, 1, 1, 1, 11, 2009);

INSERT INTO locacao (data_inicio, data_fim, valor_mensal, id_imovel, id_locatario, id_corretor, forma_pagamento) VALUES
('2024-01-10', '2024-12-31', 3500.00, 1, 1, 2, 'Cartão de Crédito'),
('2023-06-15', NULL, 2200.00, 2, 3, 6, 'Boleto Bancário'),
('2024-03-01', '2024-09-30', 4800.00, 3, 5, 2, 'Transferência Bancária'),
('2024-04-20', '2025-04-19', 1800.00, 4, 8, 11, 'Cartão de Débito'),
('2023-11-01', NULL, 3000.00, 7, 9, 6, 'Dinheiro'),
('2023-05-10', '2024-05-09', 4000.00, 5, 10, 7, 'Boleto Bancário'),
('2024-02-15', NULL, 2600.00, 6, 11, 2, 'Cartão de Crédito'),
('2024-03-25', '2024-09-25', 1900.00, 8, 2, 11, 'Transferência Bancária'),
('2023-10-01', NULL, 2200.00, 9, 4, 6, 'Cartão de Débito'),
('2024-01-20', '2024-07-19', 2700.00, 10, 6, 2, 'Dinheiro'),
('2023-12-01', NULL, 1500.00, 11, 7, 6, 'Boleto Bancário');

INSERT INTO venda (data_venda, valor_venda, id_imovel, id_comprador, id_corretor, forma_pagamento) VALUES
('2024-02-15', 850000.00, 1, 2, 1, 'Financiamento Bancário'),
('2023-09-30', 650000.00, 2, 4, 5, 'À Vista'),
('2024-05-10', 1200000.00, 3, 6, 10, 'Financiamento Bancário'),
('2024-01-05', 450000.00, 4, 7, 4, 'À Vista'),
('2023-12-20', 1400000.00, 10, 11, 3, 'Financiamento Bancário'),
('2023-11-15', 980000.00, 5, 1, 9, 'Financiamento Bancário'),
('2024-03-10', 1800000.00, 6, 3, 1, 'À Vista'),
('2023-07-25', 550000.00, 7, 5, 8, 'Financiamento Bancário'),
('2024-04-30', 750000.00, 8, 9, 7, 'À Vista'),
('2023-08-20', 650000.00, 9, 10, 1, 'Financiamento Bancário'),
('2024-05-01', 430000.00, 11, 8, 4, 'À Vista');
